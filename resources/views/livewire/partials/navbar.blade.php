            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate class="py-3 font-medium {{ request()->is('/')?'text-blue-600': 'text-gray-500'}} md:py-6 dark:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/" aria-current="page">Home</a>

                        <a wire:navigate class="py-3 font-medium {{ request()->is('categories')?'text-blue-600': 'text-gray-500'}} hover:text-gray-400 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/categories">
                            Categories
                        </a>

                        <a wire:navigate class="py-3 font-medium {{ request()->is('products')?'text-blue-600': 'text-gray-500'}} hover:text-gray-400 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/products">
                            Products
                        </a>

                        <a wire:navigate class="flex items-center py-3 font-medium {{ request()->is('cart')?'text-blue-600': 'text-gray-500'}} hover:text-gray-400 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/cart">
                        ...
                        @auth
                            <div class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] md:[--trigger:hover] md:py-4">
                                <button type="button"
                                    ...
                                    {{auth()->user()->name}}
                                    <svg class="w-4 h-4 ms-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
