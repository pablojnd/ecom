                ...
                <div class="flex flex-wrap mb-24 -mx-3">
                                ...
                                @forelse ($categories as $category)
                                    <li class="mb-4" wire:key='{{$category->id}}'>
                                        <label for="{{$category->slug}}" class="flex items-center dark:text-gray-400 ">
                                            ...
                                            <span class="text-lg">{{$category->category_name}}</span>
                                        </label>
                                    </li>
                                @empty
                            ...
                            <ul>
                               ...
                               <li class="mb-4" wire:key='{{$brand->id}}'>
                                    <label for="{{$brand->slug}} class="flex items-center dark:text-gray-300">
                                       ...
                                       <span class="text-lg">{{$brand->brand_name}}</span>
                                    </label>
                                </li>
                                @empty
                                <li>Sin Marcas</li>
                            ...
                            <ul>
                                <li class="mb-4">
                                    <label for="" class="flex items-center dark:text-gray-300">
                                        <input type="checkbox" wire:model.live="select_feature" class="w-4 h-4 mr-2">
                                        <span class="text-lg dark:text-gray-400">Feature</span>
                                    </label>
                                </li>
                                <li class="mb-4">
                                    <label for="" class="flex items-center dark:text-gray-300">
                                        <input type="checkbox" wire:model.live="select_onsale" class="w-4 h-4 mr-2">
                    ...
                    <div class="w-full px-3 lg:w-3/4">
                        ...
                        <div class="flex flex-wrap items-center ">
                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:click='{{$product->id}}'>
                                <div class="border border-gray-300 dark:border-gray-700">
                                    <div class="relative bg-gray-200">
                                        <a href="/products/{{$product->slug}}" class="">
                                            <img src="{{url('storage', $product->images[0])}}" alt="{{$product->product_name}}"
                                    ...
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            <span class="text-green-600 dark:text-green-600">$ {{$product->getFormattedPriceAttribute()}}</span>
                                        </p>
                                    </div>
